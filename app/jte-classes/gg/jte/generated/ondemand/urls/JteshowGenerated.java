...
public final class JteshowGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,1,3,3,3,5,5,8,8,11,11,11,17,17,17,21,21,21,25,25,25,30,30,30,30,43,43,44,44,46,46,46,47,47,47,48,48,48,49,49,49,50,50,50,51,51,51,53,53,54,54,57,57,57,57};
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, UrlPage page) {
		...
		gg.jte.generated.ondemand.layout.JtepageGenerated.render(jteOutput, jteHtmlInterceptor, new gg.jte.html.HtmlContent() {
			public void writeTo(gg.jte.html.HtmlTemplateOutput jteOutput) {
				...
				if (page.getUrl().getUrlCheckList() != null) {
					jteOutput.writeContent("\n                ");
					for (var check : page.getUrl().getUrlCheckList()) {
						jteOutput.writeContent("\n                    <tr>\n                        <td>");
						jteOutput.setContext("td", null);
